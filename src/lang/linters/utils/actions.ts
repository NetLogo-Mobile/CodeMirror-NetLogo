...
export const addBreedAction = function (diagnostic: Diagnostic, type: BreedType, plural: string, singular: string): Diagnostic {
...
export const addGlobalsAction = function (diagnostic: Diagnostic, type: 'Globals' | 'Extensions', items: string[]): Diagnostic {
  diagnostic.actions = [...diagnostic.actions ?? [], {
    name: Localized.Get('Add'),
    apply(view: EditorView, from: number, to: number) {
