...
import { Set, Let, To, End, ValFirstPrimitive, ValLastPrimitive, BreedFirst, BreedLast, BreedMiddle, Directive, Command, Extension, Reporter, TurtleVar, PatchVar, LinkVar, Constant, Unsupported, Identifier, Own } from "./lang.terms.js"
...
export const keyword = new ExternalTokenizer(input => {
    ...
    } else if (token=="map" || token=="reduce" || token=="filter" || token== "sort-by") {
