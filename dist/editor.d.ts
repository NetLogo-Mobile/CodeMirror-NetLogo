...
export declare class GalapagosEditor {
    ...
    AddEditor(editor: GalapagosEditor): void;
    /** AddParent: Add a parent editor. */
    AddParent(editor: GalapagosEditor): void;
    ...
    UpdateSharedContext(): void;
    SetLintContext(lint: LintContext): void;
    SetPreprocessContext(preprocess: PreprocessContext): void;
